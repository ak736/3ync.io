      ...
      {showLanding ? (
        ...
        <div>
          {showSignUp ? (
            ...
            <div class="w-full h-[850] relative bg-gray-100 overflow-hidden flex flex-row items-start justify-start py-0 pr-0 pl-[89px] box-border gap-[81px] tracking-[normal] text-center text-[24px] text-white font-inter lg:flex-wrap lg:pl-5 lg:pr-5 lg:pb-5 lg:box-border mq750:gap-[40px] mq450:gap-[20px]">
              ...
              <div class="w-[80px] flex-1 flex flex-col items-start justify-start py-0 px-0 box-border min-w-[521px] max-w-full text-[62.4px] mq750:min-w-full">
                <div class="w-[801px] self-stretch flex flex-col items-start justify-start pt-[174px] px-0 pb-1.5 box-border relative gap-[1px] max-w-full shrink-0 mq450:pt-[73px] mq450:box-border mq1050:pt-[113px] mq1050:pb-5 mq1050:box-border">
                  <div class="w-[801px]">
                    <img
                      class="w-full h-full absolute my-0 mx-[!important]  top-[0px] right-[0px] bottom-[0px] rounded-[30px] max-h-full overflow-hidden object-cover"
                      alt=""
                      src={divwlayout}
                    />
                    <div class="self-stretch flex flex-row items-start justify-start py-0 pr-px pl-[33px] box-border max-w-full">
                      <img
                        class="h-[671px] flex-1 relative max-w-full overflow-hidden object-cover z-[1]"
                        loading="eager"
                        alt=""
                        src={image5}
                      />
