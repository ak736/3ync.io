    ...
    <header className="mt-4">
      <nav className="flex flex-col md:flex-row md:justify-between md:items-center justify-start items-start mx-auto ml-8 lg:ml-16 mr-8">
        ...
        <div className="flex w-full md:w-auto items-center justify-between flex-shrink-0 mb-3">
          <a href="/" className="font-bold text-2xl mt-2 mr-0 lg:mr-3">
            3ync<span className="text-violet-700">.io</span>
          </a>
          <ion-icon
        ...
        <div
          className={`md:static md:min-h-fit min-h[60vh] left-0 top-[9%] w-full md:bg-transparent
                    flex items-start justify-end md:justify-start px-5 ${
                      menuOpen ? "block" : "hidden"
                    } md:flex`}
        >
          <ul
            className="flex backdrop-blur-2xl p-5 rounded-lg md:backdrop-blur-none md:p-0 md:rounded-none 
        ...
        <div className="flex">
          <button className="bg-black hidden lg:block text-white px-8 py-3 mr-8 rounded-full hover:bg-[#26272b] whitespace-nowrap">
            Sign up
          </button>
        </div>
      </nav>
